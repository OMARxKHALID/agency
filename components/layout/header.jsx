...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-4 py-2 mx-auto md:px-6 md:py-3 max-w-7xl">
          ...
          <nav className="items-center hidden gap-8 lg:flex">
            {navLinks.map(({ href, label }) => (
              <Link
                ...
                href={href}
                className={cn(
                  "text-lg font-mundial-demi transition-colors",
                  navTextColor
                )}
              >
                {label}
            ...
            <Link href="/contact">
              <Button className="px-10 text-lg text-white transition-colors bg-blue-600 rounded-full hover:bg-black py-9 font-mundial-demi ">
                Contact Us
