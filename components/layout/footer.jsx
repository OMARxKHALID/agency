...
export function Footer() {
  return (
    <footer className="relative px-4 py-8 overflow-hidden md:py-12 lg:py-16  inset-0 h-full w-full bg-[linear-gradient(to_right,#535353,transparent_1px),linear-gradient(to_bottom,#535353,transparent_1px)] bg-[size:12rem_12rem] bg-[#1d2027]">
